    ...
    <div className="p-6 sm:p-8 max-w-4xl mx-auto space-y-8">
      <div>
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold text-white tracking-tight">Configurações do WordPress</h1>
        </div>
      ...
      <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={isTesting}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 transition disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={isSyncing}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-sky-600/20 hover:bg-sky-600/30 text-sky-300 border border-sky-500/30 transition disabled:opacity-50"
          >
      ...
      <form onSubmit={handleSave} className="p-6 rounded-xl bg-zinc-900/60 border border-zinc-800 space-y-5">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-xs font-medium text-zinc-400 mb-1">URL do Site WordPress</label>
            <input
              type="url"
              value={url}
              ...
              required
              className="w-full px-3.5 py-2.5 rounded-lg bg-zinc-950 border border-zinc-800 text-xs text-white placeholder-zinc-600 focus:outline-none focus:border-sky-500"
            />
          </div>

          <div>
            <label className="block text-xs font-medium text-zinc-400 mb-1">Nome de Usuário</label>
            <input
              type="text"
              value={username}
