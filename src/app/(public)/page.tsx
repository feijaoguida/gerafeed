    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-white font-sans antialiased overflow-x-hidden transition-colors duration-300">
      ...
      <main>
        ...
        <section className="relative pt-16 pb-24 md:pt-24 md:pb-32 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto text-center">
          ...
          >
            Automatize seu Portal com Curadoria de Notícias via{" "}
      ...
      <footer className="border-t border-border bg-surface py-12 px-4 sm:px-6 lg:px-8 transition-colors">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 text-xs text-muted-foreground">
          <div className="flex items-center gap-3">
            <Logo href="/" size="sm" />
            <span className="text-muted-foreground">— Conteúdo que flui. Inteligência que publica.</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto mt-6 pt-6 border-t border-border text-center text-[11px] text-muted-foreground">
