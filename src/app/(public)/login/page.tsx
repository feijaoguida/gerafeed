        ...
        <div className="w-full max-w-[420px] mx-auto space-y-7 my-auto">
          <div>
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1.5 leading-relaxed">
              Entre para continuar transformando seus artigos em posts.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    alert("Para redefinir sua senha, entre em contato com o suporte ou use as credenciais de administrador.");
                  }}
                  className="text-xs font-semibold text-[#1E3EB3] dark:text-indigo-400 hover:underline transition"
                >
                  Esqueceu a senha?
                </a>
              </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 px-4 rounded-xl font-semibold text-white bg-[#00C06A] hover:bg-[#00AB5E] transition shadow-md shadow-emerald-600/20 active:scale-[0.99] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
